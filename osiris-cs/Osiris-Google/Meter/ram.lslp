string scriptName = "ram";
string secureKey="7yxpZa2Rfq/wG/LRGidWJCy8BAw=";
string myKey="2KFAdLbWTgV55oTiq/K3IXC54vA=";
...
string process(string input) {
    input = StringReplace(input, "Ã¦", "ae");
    input = StringReplace(input, "Ã¸", "oe");
    input = StringReplace(input, "Ã¥", "aa");
